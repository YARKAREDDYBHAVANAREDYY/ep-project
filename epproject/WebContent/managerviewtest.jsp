...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <div class="collapse navbar-collapse" id="collapsibleNavbar">
    <ul class="navbar-nav">
    <li class="nav-item">
        <a style="color:red" class="nav-link" href="managerpage.html">MANAGER HOMEPAGE</a>
      </li>
      <li class="nav-item">
        <a style="color:red" class="nav-link" href="addtest.html">ADD TEST  </a>
      </li> 
       <li class="nav-item">
        <a style="color:red" class="nav-link" href="managerviewequipment.jsp">VIEW EQUIPMENT</a>
      </li>
      <li class="nav-item">
        <a style="color:red" class="nav-link" href="addequipment.html">ADD EQUIPMENT</a>
      </li>
